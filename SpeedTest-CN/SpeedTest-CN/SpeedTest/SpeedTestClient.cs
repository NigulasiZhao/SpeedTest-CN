...
namespace SpeedTest_CN.SpeedTest
{
    public class SpeedTestClient : ISpeedTestClient
    {
        ...
        private static readonly int[] DownloadSizes = { 6000,6000, 6000 };
        ...
        public Settings GetSettings()
        {
            ...
            var settings = client.GetSystemConfig<Settings>(ConfigUrl).GetAwaiter().GetResult();
